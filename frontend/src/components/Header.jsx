            ...
            <Toolbar className="toolbar">
                ...
                <Box className="nav-links">
                    ...
                    {user ? (
                        <>
                            {user.role === "client" && (
                                <Button className="nav-button" component={Link} to="/client-profile">
                                    Hello, {user.name} {user.surname}
                                </Button>
                            )}
                            {user.role === "talent" && (
                                <Button className="nav-button" component={Link} to="/talent-profile">
                                    Hello, {user.name} {user.surname}
                                </Button>
                            )}
                            {user.role === "agency" && (
                                <Button className="nav-button" component={Link} to="/agency-profile">
